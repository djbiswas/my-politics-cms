<x-app-layout>
    ...
    <div class="generic-form" style="text-align: left;">
        ...
        <form class="needs-validation-1" action="{{route('post.ban')}}" method="post" id="userbanform" name="form_03" enctype="multipart/form-data" novalidate>
            ...
            <div class="row">
                <div class="form-group col-6">
                    ...
                    <input type="text" required class="form-control" name='ban_till' id="ban_till" placeholder="Ban Duration" value="{{ (!empty($data)) ? $data->ban_till : '' }}">
            ...
            <div class="row">
                <div class="form-group col-6">
                    ...
                    <label id="ban_reason_error" class="text-danger " for="ban_reason"> This field is required.</label>
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-6">
                    ...
                    <div class="form-group">
                        <input type="checkbox" {{((!empty($data) && $data->user_ban == 1)) ? 'checked' : ''}} data-toggle="toggle" name="user_ban" value="1" data-on="Activate" data-off="Deactivate" data-onstyle="primary" id="user_ban">
                    </div>
                </div>
            </div>
            ...
            {{-- <div class="row">
                <div class="col-6">
                    <input id="Test Mail" type="submit" name='Send' class="btn btn-primary float-right"  value="Save">
                </div>
            </div> --}}
        ...
        <form class="needs-validation-1" action="{{route('post.block')}}" method="post" id="userBlockForm" name="form_01" enctype="multipart/form-data" novalidate>
            ...
            <div class="row">
                <div class="form-group col-6">
                    ...
                    <label id="block_reason_error" class="text-danger " for="block_reason"> This field is required.</label>
            ...
            <div class="row">
                <div class="form-group col-6">
                    <div class="form-group">
                        <input type="checkbox" {{((!empty($data) && $data->user_block == 1)) ? 'checked' : ''}} data-toggle="toggle" name="user_block" value="1" data-on="Activate" data-off="Deactivate" data-onstyle="primary" id="user_block" >
                    </div>
                </div>
            </div>
    ...
    {{-- <script src="//ajax.aspnetcdn.com/ajax/jquery.validate/1.11.1/additional-methods.js"></script> --}}
        ...
        <script>
            ...
            $("#user_ban").change(function(){
                if($(this).prop("checked") == true){
                    if (!$('#ban_reason').val()) {
                        $('#user_ban').bootstrapToggle('off', true);
            ...
            $("#user_block").change(function(){
                if($(this).prop("checked") == true){
                    if (!$('#block_reason').val()) {
                        $('#user_block').bootstrapToggle('off', true);
                        $('#block_reason_error').show();
                        $('#block_reason').focus();
                    }else{
                        $( "#userBlockForm" ).submit();
                    }
                }else{
                    $( "#userBlockForm" ).submit();
                }
